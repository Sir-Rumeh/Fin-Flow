        ...
        <div className="mt-5 rounded-lg bg-white px-5 py-8">
          ...
          <div className="mt-4 flex flex-col items-center justify-between md:flex-row">
            ...
            <CustomInput
              labelFor="merchantId"
              label="Report Type"
              containerStyles="flex h-[50px] items-center justify-between rounded-lg border border-gray-300 px-1 md:w-[230px]"
              inputStyles="h-[40px] w-[180px] px-2 focus:outline-none focus:ring-0"
              inputType="text"
