...
const StaffUserDisableRequestDetails = () => {
    ...
    <>
      ...
      {modals.confirmApproveRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to approve this disable user request, would you want to proceed with this?'
          }
          icon={<RedAlertIcon />}
          type={'confirmation'}
          proceedAction={() => {
      ...
      {modals.approveSuccessfulModal && (
        <ModalWrapper
          ...
          title={'Success!!'}
          info={'You have successfully approved this disable user request'}
      ...
      {modals.confirmRejectRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to reject this disable user request, would you want to proceed with this?'
          }
          feedback={
      ...
      {modals.rejectSuccessfulModal && (
        <ModalWrapper
          ...
          title={'Success!!'}
          info={'You have successfully rejected this disable user request'}
          icon={<ActionSuccessIcon />}
          type={'completed'}
          proceedAction={() => {
...
export default StaffUserDisableRequestDetails;
