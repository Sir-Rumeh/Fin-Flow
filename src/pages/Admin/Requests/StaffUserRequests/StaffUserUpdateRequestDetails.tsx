    ...
    <>
      ...
      {modals.confirmApproveRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to approve this user update request, would you want to proceed with this?'
          }
          icon={<RedAlertIcon />}
          type={'confirmation'}
          proceedAction={() => {
      ...
      {modals.approveSuccessfulModal && (
        <ModalWrapper
          ...
          title={'Success!!'}
          info={'You have successfully approved this user update request'}
      ...
      {modals.confirmRejectRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to reject this user update request, would you want to proceed with this?'
          }
          feedback={
      ...
      {modals.rejectSuccessfulModal && (
        <ModalWrapper
          ...
          title={'Success!!'}
          info={'You have successfully rejected this user update request'}
          icon={<ActionSuccessIcon />}
          type={'completed'}
          proceedAction={() => {
...
export default StaffUserUpdateRequestDetails;
