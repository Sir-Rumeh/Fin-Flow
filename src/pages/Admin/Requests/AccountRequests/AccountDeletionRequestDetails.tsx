    ...
    <>
      ...
      {modals.confirmApproveRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to approve this new account deletion request, would you want to proceed with this?'
          }
          icon={<RedAlertIcon />}
          type={'confirmation'}
          proceedAction={() => {
      ...
      {modals.confirmRejectRequest && (
        <ModalWrapper
          ...
          info={
            'You are about to reject this account deletion request, would you want to proceed with this?'
          }
          feedback={
      ...
      {modals.rejectSuccessfulModal && (
        <ModalWrapper
          ...
          title={'Success!!'}
          info={'You have successfully rejected this account deletion request'}
          icon={<ActionSuccessIcon />}
          type={'completed'}
          proceedAction={() => {
...
export default AccountDeletionRequestDetails;
